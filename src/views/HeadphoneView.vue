<template>
  <main>
    ...
    <section class="container mx-auto md:py-40 px-4 md:px-0 mb-32">
      <HeadphoneProducts :products="headphoneProducts"></HeadphoneProducts>
    </section>
    <section class="py-20">
...
<script>
import HeadphoneProducts from "@/components/common/AllProducts.vue";
...
export default {
  ...
  computed: {
    headphoneProducts() {
      return this.$store.getters["products/headphones"];
    },
  },
};
</script>