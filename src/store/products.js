export default {
    ...
    actions: {
        getProduct(context, payload) {
            const headphones = context.getters.headphones
            const speakers = context.getters.speakers
            const earphones = context.getters.earphones
            let product
            if (payload.type == 'headphones') {
                product = headphones.find((headphone) => headphone.id === parseInt(payload.id))
            } else if (payload.type == 'speakers') {
                product = speakers.find((headphone) => headphone.id === parseInt(payload.id))
            } else {
                product = earphones.find((headphone) => headphone.id === parseInt(payload.id))
            }
